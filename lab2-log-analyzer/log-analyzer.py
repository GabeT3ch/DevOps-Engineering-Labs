...
def parse_arguments():
    ...
    # TODO: Add a positional argument for the log file path
    # TODO: Add optional arguments for --level, --keyword, --after, --before
    # HINT: argparse.ArgumentParser(), parser.add_argument()
    pass
